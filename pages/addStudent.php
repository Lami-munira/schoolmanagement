...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addstud'])) {
        ...
        $che = "Select * from student where email = '$email';";
        ...
        if (mysqli_num_rows($R)) {
            ...
            $che = "INSERT INTO `student` (`id`, `name`, `current_class`, `phone`, `email`, `gender`, `password`, `address`, `dob`) VALUES (NULL, '$name', '$class', '$phone', '$email', '$gender', '$pass', '$address', '$dob');";
            $R = mysqli_query($conn, $che);
            if ($R) {
...
<body>
    ...
    <div class="cont">
        <br>
        <h4> Enter the information of the student<br><br></h4>
        ...
        <form action="addStudent.php" method="post">
            ...
            <button  name="addstud" class="green-button">Submit</button> <br>
